...
<h2>Crear Factura</h2>
<div id="crear">
  <form name="form" action="editarClienteExecute.php" method="post" title="Permite Crear una Factura" onsubmit="return validarVacio(this);">
    <fieldset id="factura" >
      <legend align="center">Buscar Cliente para Editar</legend>
      <br />
