...
Array.prototype.formateaLista = function() {
  ...
  for(var i=0; i<this.length; i++) {
    if(i == elementoSeleccionado) {
      codigoHtml += "<li style=\"font-weight:bold; color:#333; background-color: #ffe594; padding: .1em; border-bottom: 1px dotted #ffe594; cursor:pointer;\"><a href=\"#\" onClick=\"colocarValor('"+this[i]+"')\">"+this[i].substring(0,this[i].indexOf('-'))+"</a></li>";
    }
    else {
      codigoHtml += "<li style=\"padding: .1em; border-bottom: 1px dotted #ffe594; cursor:pointer;\"><a href=\"#\" onClick=\"colocarValor('"+this[i]+"')\">"+this[i].substring(0,this[i].indexOf('-'))+"</a></li>";
    }
  }
  codigoHtml += "</ul>";
